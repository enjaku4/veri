...
- Specify the versions of Veri, Ruby, Rails, etc.
...
By submitting a pull request, you indicate that you waive any rights or claims to the modifications made in the Veri project and transfer the copyright of those changes to the Veri gem copyright owners.

If you are unable or unwilling to transfer these rights, please refrain from submitting a pull request.

## Local Development

Use the Ruby version specified in the `very.gemspec` file.
